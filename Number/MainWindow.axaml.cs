...
namespace Number
{
    public partial class MainWindow : Window
    {
        ...
        public void ClickMinus(object? sender, RoutedEventArgs args)
        {
            string s = Input.Text;
        ...
        {
            if (ButtonClickRandom.Parent is Panel parentPanel)
            {
                parentPanel.Children.Remove(ButtonClickRandom);
            }
        ...
        public void NextOutputClick(object? sender, RoutedEventArgs args)
        {
            ...
            string three = MyComboBox3.SelectedItem.ToString();

            string result = first + second + three;

            comboboxMessage.Text = "Your phone number is +" + result.ToString();
